...
function Header({ showCalendar}) {
  ...
  const handleUserIconClick = (event) => {
    if (localStorage.getItem('authToken')) {
      ...
      // Si el usuario es un administrador, navega a la página de administración
                ...
                >
                  ...
                  {isHovered && (
                    ...
                    <StyledLink to="/Contacto">CONTACTO</StyledLink>
                          ...
                          <RightNav>
                          <StyledLink to="/IniciarSesion" onClick={handleUserIconClick}>
                            <FaUser size={30}  />
                          </StyledLink>
