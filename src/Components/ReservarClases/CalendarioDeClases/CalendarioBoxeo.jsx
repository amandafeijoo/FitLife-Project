...
import ReservarClaseBoxeo from '../ReservarClaseBoxeo';
...
function CalendarioBoxeo ({ setSelectedClass,selectedClass, setModalIsOpen, handleCloseModal }) {
  const [classes, setClasses] = useState(HorarioBoxeo);
