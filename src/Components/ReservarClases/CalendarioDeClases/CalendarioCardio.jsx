...
import ReservarClaseCardio from '../ReservarClaseCardio';
...
const HorarioCardio ={ 
        ...
        Lunes: [
        { time: '19:00', endTime: '20:00', instructor: 'Andrea', class: 'Intenso' }
        ],
        Miércoles: [
        { time: '12:00', endTime: '13:00', instructor: 'Andrea', class: 'Tonificación' }
        ],
        Domingo: [   
        { time: '11:30', endTime: '12:30', instructor: 'Andrea', class: 'Kickboxing' },
        { time: '9:00', endTime: '10:00', instructor: 'Andrea', class: 'Dance' }
        ],
    };

function CalendarioCardio({  setSelectedClass,selectedClass, setModalIsOpen, handleCloseModal }) {
  const [classes, setClasses] = useState(HorarioCardio);

  console.log(classes);  
  
  const colors = {
        'Intenso': 'lightpink',
        'Tonificación': 'lightblue',
        'Kickboxing': 'lightgreen',
        'Dance': 'lightyellow',
      };
    ...
    const times = ['9:00', '10:00','11:00','11:30','12:00', '19:00', '19:30'];
