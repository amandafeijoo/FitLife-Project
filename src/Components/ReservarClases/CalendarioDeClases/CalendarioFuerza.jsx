...
import ReservarClaseFuerza from '../ReservarClaseFuerza';
...
const HorarioFuerza = { 
    ...
    Domingo: [
      { time: '13:00', endTime: '14:00', instructor: 'Diego', class: 'Pesas' }
    ],
  };
...
function CalendarioFuerza({ setSelectedClass,selectedClass, setModalIsOpen, handleCloseModal }) {

  const [classes, setClasses] = useState(HorarioFuerza);
