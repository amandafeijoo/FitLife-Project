...
import ReservarClaseYoga from '../ReservarClaseYoga';
...
const HorarioYoga ={ 
    ...
    Lunes: [
        { time: '7:00', endTime: '8:00', instructor: 'Laura', class: 'Matutino',maxCapacity: 10 },
        { time: '19:00', endTime: '20:00', instructor: 'Laura', class: 'Suave y Meditación',maxCapacity: 10}
      ],
        Martes: [
        { time: '10:00', endTime: '11:00', instructor: 'Martha', class: 'Restaurativo',maxCapacity: 10}
        ],
        Miercoles: [
        { time: '7:00', endTime: '8:00', instructor: 'Martha', class: 'Dinámico',maxCapacity: 10}
        
        ],
        Jueves: [
        { time: '19:30', endTime: '20:30', instructor: 'Laura', class: 'Flexibilidad',maxCapacity: 10}
        
        ],
        Viernes: [
        { time: '12:00', endTime: '13:00', instructor: 'Laura', class: 'Hatha Yoga',maxCapacity: 10}
        ],
        Sabado: [
        { time: '10:30', endTime: '11:30', instructor: 'Martha', class: 'Al Aire Libre',maxCapacity: 15}
        ],
        Domingo: [
            
        { time: '10:00', endTime: '11:00', instructor: 'Laura', class: 'Relajación y Estiramiento',maxCapacity: 10}
        ],
 ...
 function CalendarioYoga({ setSelectedClass,selectedClass, setModalIsOpen, handleCloseModal }) {
  const [classes, setClasses] = useState(HorarioYoga);
